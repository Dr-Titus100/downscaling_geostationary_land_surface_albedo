...
# Directories
S2_BLUE_SKY_ALBEDO_DIR = "/bsuhome/tnde/scratch/felix/modis/blue_sky_albedo_sail_new/"
...
TF_HISTORY_PATH = "/bsuhome/tnde/scratch/felix/unet_goes_s2/Results/training/history_new_old.json"
...
goes_train_path = "/bsuhome/tnde/scratch/felix/GOES/data/nan_data_new/*.tif"
...
for s2_date in list(cf_vals["date"]):
    ...
    goes_unet_train_file = (
        f"/bsuhome/tnde/scratch/felix/GOES/data/nan_data_new/"
        f"OR_ABI-L2-LSAC-M6_G16_{s2_date}.tif"
    )
...
# ----------------- Matching test files -----------------
goes_test_path = "/bsuhome/tnde/scratch/felix/GOES/data/nan_data_new/*.tif"
